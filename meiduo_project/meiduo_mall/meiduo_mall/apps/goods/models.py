...
class SPU(BaseModel):
    ...
    desc_detail = models.IntegerField(default='', verbose_name='详细介绍')
    desc_pack =  models.IntegerField(default='', verbose_name='包装信息')
    desc_service =  models.IntegerField(default='', verbose_name='售后服务')
...
class SPUSSpecification(BaseModel):
    """商品SPU规格"""
    spu = models.ForeignKey(SPU, on_delete=models.CASCADE, verbose_name='商品')
...
class SpecificationOption(BaseModel):
    """规格选项"""
    spec = models.ForeignKey(SPUSSpecification, related_name='options',on_delete=models.CASCADE, verbose_name='规格')
...
class SKUSpecification(BaseModel):
    """SKU具体规格"""
    sku = models.ForeignKey(SKU, on_delete=models.CASCADE, verbose_name='sku')
    spec = models.ForeignKey(SPUSSpecification,on_delete=models.PROTECT,verbose_name='规格')
    option = models.ForeignKey(SpecificationOption,on_delete=models.PROTECT,verbose_name='选项值')
    class Meta:
        db_table = 'tb_sku_specification'
        verbose_name = 'SKU规格'
        verbose_name_plural = verbose_name
    def __str__(self):
        return '%s: %s - %s' % (self.sku,self.spec, self.option)
