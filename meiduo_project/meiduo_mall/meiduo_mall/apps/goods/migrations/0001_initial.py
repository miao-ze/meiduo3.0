    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category1', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cat1_goods', to='goods.goodscategory', verbose_name='一级类别')),
                ('category2', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cat2_goods', to='goods.goodscategory', verbose_name='二级类别')),
                ('category3', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cat3_goods', to='goods.goodscategory', verbose_name='三级类别')),
            ],
            options={
                'verbose_name': '商品SPU',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spec', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='options', to='goods.spusspecification', verbose_name='规格')),
            ],
            options={
                'verbose_name': '规格选项',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('sku', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.sku', verbose_name='sku')),
                ('option', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='goods.specificationoption', verbose_name='选项值')),
                ('spec', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='goods.spusspecification', verbose_name='规格')),
            ],
            options={
                'verbose_name': 'SKU规格',
