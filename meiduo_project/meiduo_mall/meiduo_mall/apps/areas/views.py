        ...
        if not area_id:
            ...
            if not province_list:
                try:
                    ...
                    cache.set('province_list',province_list,constans.AREA_CACHE_EXPIRE_TIME) #过期时间为一小时
            ...
            if not sub_data:
                try:
                    ...
                    # 进行存储市级或区县级数据
                    cache.set('sub_area_' + area_id,sub_data,constans.AREA_CACHE_EXPIRE_TIME) #过期时间为一小时
                    # 响应城市或区县JSON数据:大致如下
                    """
                    "code": "0",
                    "errmsg": "OK",
